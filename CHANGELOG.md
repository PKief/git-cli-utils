...
- **commits:** Add branch filtering to search commits and implement searchBranchCommits utility ([c8f656c](https://github.com/PKief/git-cli-utils/commit/c8f656c))
- **branches:** Add search commits action for remote branches ([f5479e3](https://github.com/PKief/git-cli-utils/commit/f5479e3))
- **release:** Bump version to 1.23.0 and update package-lock.json ([4f3240d](https://github.com/PKief/git-cli-utils/commit/4f3240d))
- **release:** Bump version to 1.24.0 in package.json and package-lock.json ([fd9f238](https://github.com/PKief/git-cli-utils/commit/fd9f238))
- **ci:** Update release yml ([1f32ad0](https://github.com/PKief/git-cli-utils/commit/1f32ad0))
- Refactor code for better maintainability ([ef605bc](https://github.com/PKief/git-cli-utils/commit/ef605bc))
...
- **release:** Pull latest main before changelogen to prevent orphaned version commits ([c908d60](https://github.com/PKief/git-cli-utils/commit/c908d60))
